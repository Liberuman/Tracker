 ...
 */
public class LifecycleFragment extends com.sxu.trackerlibrary.listener.LifecycleFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragment_lifecycle_layout, container, false);
	}
	...
	public void setUserVisibleHint(boolean isVisibleToUser) {
		...
		Log.i("out", "=========******setUserVisibleHint " + isVisibleToUser);
	}

	@Override
	public void onHiddenChanged(boolean hidden) {
		super.onHiddenChanged(hidden);
		Log.i("out", "=========******onHiddenChanged " + hidden);
	}
}
